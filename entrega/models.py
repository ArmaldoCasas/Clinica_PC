...
class ReporteEntrega(models.Model):
    ...
    diagnostico = models.ForeignKey(Estudiante, on_delete=models.SET_NULL, null=True, blank=True, related_name="reportes_diagnostico")
    solucion = models.ForeignKey(Estudiante, on_delete=models.SET_NULL, null=True, blank=True, related_name="reportes_soluciones")
